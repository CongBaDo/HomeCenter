...
package com.HomeCenter2.contact.util;
...
public class MemInfoReader {
    ...
    /***
     * Wrap readMemInfo API to ensure it can be run from SDK API-8
     * The StrictMode.ThreadPolicy is only supported from API-9
     */
    public void readMemInfo()
    {    
        // Since HomeCenter2 only support from MinSDK 2.2
        // so we dont care to check earlier SDK version
