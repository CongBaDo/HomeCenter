...
public class AccountFragment extends RADialerMainScreenAbstract implements
	...
	public static AccountFragment initializeParameterConfigDevice(
			int titleId, String tag, SlidingBaseActivity mContext) {

		if (nInstance == null) {
			nInstance = new AccountFragment(titleId, tag, mContext);
		}
		return nInstance;
	}
