...
public class Fan extends LampRoot {
	...
	public Fan(int id, String name, boolean state) {
		super(id, name, state);	
	}
	...
	public void setOnIcon() {
		icon = R.drawable.ic_fan_blk_43;		
	}
	
	@Override
	public void setOffIcon() {
		icon = R.drawable.ic_fan_wht_43;
		
	}
	
	public int getLightIcon(){
		return R.drawable.ic_fan_blk_43;
	}
}
