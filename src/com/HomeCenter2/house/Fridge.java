...
public class Fridge extends LampRoot {

	public Fridge() {
		super();
		icon = R.drawable.ic_fridge_blk;
	}

	private static final String TAG = "TMT Fridge";

	public Fridge(int id, String name, boolean state) {
		super(id, name, state);
		icon = R.drawable.ic_fridge_blk;
	}
	...
	public void setIcon() {
		icon = R.drawable.ic_fridge_blk_64;
	}
	...
	public void setOffIcon() {
		icon = R.drawable.ic_fridge_wht_64;
		
	}
	
	public int getLightIcon(){
		return R.drawable.ic_fridge_blk_64;
	}
}
