...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private static final int DEFAULT_SCROLL_TOLERANCE = 40;
	...
	private int mScrollTolerance = DEFAULT_SCROLL_TOLERANCE;
	...
	private void init(Context context) {
		...
		if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.GINGERBREAD) {
			setOverscrollFooter(mContext.getResources().getDrawable(
					R.color.black));
		}
	}
	...
	protected void onAttachedToWindow() {
		setSelection(1);
		super.onAttachedToWindow(); // don't forget this command as calling
									// onAttachedToWindow
		// on os 4.0 or higher, it gets a stuck on UI, the listview item cannot
		// be selected.
	}
	...
	/**
	 * Set the mRoomMenuListener that will receive notifications every time the list
	 * scrolls.
	 * 
	 * @param l
	 *            The scroll mRoomMenuListener.
	 */
	@Override
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (getFirstVisiblePosition() == 0
					&& y > mLastMotionY + mRefreshViewHeight + mScrollTolerance) {
	...
	public void setScrollTolerance(int scrollTolerance) {
		mScrollTolerance = scrollTolerance;
	}
}